...
class _HomeScreenState extends State<HomeScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.settings_outlined, color: Color(0xFF2A9D8F), size: 20),
                      ),
              ...
              Row(
                children: [
                  Expanded(child: _buildStatCard("Total Forms", "24", Icons.description_outlined)),
                  const SizedBox(width: 10),
                  Expanded(child: _buildStatCard("Total Responses", "1.2k", Icons.people_outline)),
                  const SizedBox(width: 10),
                  Expanded(child: _buildStatCard("Published", "88%", Icons.star_border)),
                ],
              ),
              ...
              Row(
                ...
                children: const [
                  ...
                  Text(
                    "View all",
                    style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFF2A9D8F)),
                  ),
                ],
              ),
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          items: const [
            ...
            BottomNavigationBarItem(
              icon: SizedBox.shrink(), // Dikosongkan karena tengah ada tombol plus
              label: '',
            ),
            BottomNavigationBarItem(
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.description_outlined, color: Color(0xFF2A9D8F), size: 20),
              ),
              Row(
                children: [
                  Container(
          ...
          Row(
            children: [
              ...
              Text(responses, style: const TextStyle(fontSize: 12, color: Colors.grey)),
            ...
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: () {},
                  icon: const Icon(Icons.edit_outlined, size: 14, color: Color(0xFF2A9D8F)),
                  label: const Text("Edit Design", style: TextStyle(fontSize: 12, color: Color(0xFF2A9D8F))),
              ...
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: () {},
                  icon: const Icon(Icons.show_chart, size: 14, color: Color(0xFF2A9D8F)),
                  label: const Text("Analytics", style: TextStyle(fontSize: 12, color: Color(0xFF2A9D8F))),
                  style: OutlinedButton.styleFrom(
                    side: const BorderSide(color: Color(0xFF2A9D8F)),
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                  ),
  ...
  Widget _buildActivityItem(String title, String subtitle, String time, Color iconBg, Color iconColor, IconData icon) {
    return Padding(
